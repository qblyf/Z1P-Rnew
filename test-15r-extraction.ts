...
console.log('测试1: "红米 15R 全网通5G版 4GB+128GB 星岩黑"');
const result1 = extractModelFromSPU('红米 15R 全网通5G版 4GB+128GB 星岩黑', '红米');
console.log(`结果: "${result1}"\n`);

console.log('测试2: "Redmi 15R 全网通5G 4GB+128GB 星岩黑"');
const result2 = extractModelFromSPU('Redmi 15R 全网通5G 4GB+128GB 星岩黑', 'Redmi');
console.log(`结果: "${result2}"\n`);

console.log('测试3: "红米 15R"');
const result3 = extractModelFromSPU('红米 15R', '红米');
